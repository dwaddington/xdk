...
#define LO(ptr) \
        ((uint32_t) (((uint64_t) ((addr_t) (ptr))) & 0xffffffff))

#define HI(ptr) \
        ((uint32_t) (((uint64_t) ((addr_t) (ptr))) >> 32))
...
#define AHCI_MAX_COMMAND_SLOTS 6
