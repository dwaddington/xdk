...
/*
  Authors:
  Copyright (C) 2011-2014, Daniel G. Waddington <daniel.waddington@acm.org>
*/
...
#define USE_GCC_CAS_INTRINSIC
#else
inline bool __sync_bool_compare_and_swap(volatile int *dest, 
                                        int cmp_val, 
                                        int new_val) 
{
...
namespace Exokernel
{
  ...
  public:
    ...
    INLINE atomic_t read() {
      return __sync_fetch_and_add(&__atomic, 0UL);
    }
    ...
    INLINE void increment() {
      __sync_fetch_and_add(&__atomic, 1UL);
    }
    ...
    INLINE void decrement() {
      __sync_fetch_and_sub(&__atomic, 1UL);
    }
    ...
    INLINE atomic_t compare_and_swap(Atomic oldval, Atomic newval) {
      return __sync_val_compare_and_swap(&__atomic,
                                         oldval.get_value_unsafe(),
    ...
    static INLINE atomic_t compare_and_swap(atomic_t *mem,
                                            atomic_t oldval,
                                            atomic_t newval) {
    ...
    INLINE bool cas_bool(Atomic v, Atomic q) {
      return __sync_bool_compare_and_swap(&__atomic,
                                          v.get_value_unsafe(),
                                          q.get_value_unsafe());
    }
    static INLINE bool cas_bool(atomic_t *mem,
                                atomic_t v,
                                atomic_t q) {
      return __sync_bool_compare_and_swap(mem, v, q);
    }

    static INLINE void increment(atomic_t * mem) {
      __sync_fetch_and_add(mem,1);
    }

    static INLINE void decrement(atomic_t * mem) {
